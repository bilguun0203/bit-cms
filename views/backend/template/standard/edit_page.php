                    ...
                    <div class="col-md-8">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                Хуудас үүсгэх <?php echo $data['method']; ?>
                            </div>
                            <div class="panel-body">

                                <input id="method" name="method" type="text" value="<?php echo $data['method']; ?>" hidden>
                                <input id="id" name="id" type="text" value="<?php echo $data['page']['id'] ?>" hidden>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="title">Гарчиг</label>
                                        <input class="form-control" id="title" name="title" type="text" value="<?php if($data['method']=="edit") echo $data['page']['title']; ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="link">Хаяг</label>
                                        <input class="form-control" id="link" name="link" type="text" value="<?php if($data['method']=="edit") echo $data['page']['link']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type">
                                        ...
                                        <option value="homepage">Нүүр хуудас</option>
                                    </select>
                                </div>
                                <div class="form-group">
...
<!--                                        <option>5</option>-->
<!--                                    </select>-->
                                    <input class="form-control" id="category" name="category" type="text" value="<?php if($data['method']=="edit") echo $data['page']['category']; else echo "Ангилалгүй"; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="tags">Шошго</label>
                                    <input class="form-control" id="tags" name="tags" type="text" data-role="tagsinput" value="<?php if($data['method']=="edit") echo $data['page']['tags']; ?>">
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="alert alert-primary">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="imgSource" name="imgSource">
                                            ...
                                            <option value="url" <?php if($data['method']=="edit" && ($data['page']['image']!="" || $data['page']['image']!=NULL)) echo "selected"; ?>>Холбоос</option>
                                            <option value="file">Хуулах</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="imgURL">
                                        <label class="control-label" for="imgS">Хаяг</label>
                                        <input class="form-control" id="imgS" name="imgS" type="text" placeholder="http://" value="<?php if($data['method']=="edit") echo $data['page']['image']; ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-success">
                                        <input type="radio" name="visibility" id="v1" value="1" <?php if($data['method']=="edit" && $data['page']['visibility']==1) echo "checked"; else echo "checked"; ?>>
                                        <label for="v1">
                                            Нийтлэгдэнэ
                                        </label>
                                    </div>
                                    <div class="radio radio-danger">
                                        <input type="radio" name="visibility" id="v2" value="0" <?php if($data['method']=="edit" && $data['page']['visibility']==0) echo "checked"; ?>>
                                        <label for="v2">
                                            Ноорог
                                        </label>
                                    </div>
                                    <div class="radio radio-warning">
                                        <input type="radio" name="visibility" id="v3" value="2" <?php if($data['method']=="edit" && $data['page']['visibility']==2) echo "checked"; ?>>
                                        <label for="v3">
                                            Хүлээлгэнд
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-success">
                                        <input type="radio" name="comment" id="c1" value="1" <?php if($data['method']=="edit" && $data['page']['comments_allowed']==1) echo "checked"; else echo "checked"; ?>>
                                        <label for="c1">
                                            Зөвшөөрнө
                                        </label>
                                    </div>
                                    <div class="radio radio-danger">
                                        <input type="radio" name="comment" id="c2" value="0" <?php if($data['method']=="edit" && $data['page']['comments_allowed']==0) echo "checked"; ?>>
                                        <label for="c2">
                                            Зөвшөөрөхгүй
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control datepicker" name="pubdate" id="pubdate" type="text"  value="<?php if($data['method']=="edit") echo $data['page']['pubdate']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
